...
import com.hvasoft.weather.data.network.JSONFileLoader
...
class MainViewModelTest {
    ...
    private lateinit var service: WeatherApiClient
    ...
    @Before
    fun setup() {
        service = retrofit.create(WeatherApiClient::class.java)
